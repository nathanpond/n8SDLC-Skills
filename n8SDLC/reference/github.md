...
## Where
<production | preview/stage | local dev — and the path/command that hits it>
...
## Evidence
<console output, failing request, stack trace, screenshot>
```
