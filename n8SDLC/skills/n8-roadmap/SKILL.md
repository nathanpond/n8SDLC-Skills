...
The user describes the overall goal, expected features, and acceptance criteria. Ask clarifying questions until you could defend the epic list to a skeptical PM. Cover at minimum:
...
- **M<N>: Audit** — always last: audit passes (`/n8-audit`) and approved finding fixes.
