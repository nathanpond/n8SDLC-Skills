...
| `/n8-audit` | Audit suite: security, stability, performance, cleanup, authorization, 508. Stack-appropriate tooling (CodeQL, semgrep, dependency audits, fuzzing where applicable). Reports findings, asks which to file as issues. |
